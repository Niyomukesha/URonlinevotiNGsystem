...
<label>Program of Study <i>(enter initials only i.e LLB,BFIN,CSE, BIT..)</i></label><br/>
												
<input class="form-control"  type = "text" name = "prog_study" placeholder="E.g BIT, LLB,BFIN,CSE BITED" required="true">
